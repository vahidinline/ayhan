...
const Terms = () => {
  return (
    <div className="container p5">
      ...
      <p>Welcome to Ayhan Design!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Ayhan OU's Website, located at https://ayhandesign.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Ayhan Design if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Ayhan Design, you agreed to
        use cookies in agreement with the Ayhan OU's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Ayhan OU and/or its licensors own the
        intellectual property rights for all material on Ayhan Design. All
        intellectual property rights are reserved. You may access this from
        Ayhan Design for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Ayhan Design</li>
        <li>Sell, rent or sub-license material from Ayhan Design</li>
        <li>Reproduce, duplicate or copy material from Ayhan Design</li>
        <li>Redistribute content from Ayhan Design</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Ayhan
        OU does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Ayhan OU,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Ayhan OU shall not be liable for the
      ...
      <p>
        Ayhan OU reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Ayhan OU a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Ayhan OU; and (d) the link is
      ...
      <p>
        ...
        e-mail to Ayhan OU. Please include your name, your organization name,
      ...
      <p>
        No use of Ayhan OU's logo or other artwork will be allowed for linking
